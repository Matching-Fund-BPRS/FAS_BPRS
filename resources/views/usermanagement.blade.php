                            ...
                            <td class="align-center py-2 font-medium whitespace-nowrap">
                                <div class="flex space-x-1 ">
                                    ...
                                    <form method="post" action="{{ route('delete-user') }}">
                                        ...
                                        <button type="submit" id="delete_user_{{ $user->username }}" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Delete User</button>
                                    </form>
                                </div>
                            </td>
                        </tr>
