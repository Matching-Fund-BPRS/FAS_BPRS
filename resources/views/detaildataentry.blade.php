...
<ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400">
    ...
    <li class="mr-2">
        @if($nasabah != null)
            <a href="/dashboard/detaildataBU/{{ $nasabah->ID_NASABAH }}" class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 dark:hover:text-gray-300">Badan Usaha</a>
        @else
                ...
                <div class="flex space-x-2 max-w-md">
                    ...
                    <div>
                        ...
                        <div class="flex space-x-2">
                            ...
                            <div class="flex my-auto items-center">
                                <input name="tgl_berlaku_ktp" id="default-radio-2" type="radio" name="default-radio" class=" my-auto w-4 h-4 text-green-600 bg-gray-100 border-gray-300 focus:ring-green-500 dark:focus:ring-green-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
...
<form method="POST" action="/dashboard/detaildata/{{ $nasabah->ID_NASABAH }}/edit">
    ...
    <section id="start" class="md:flex md:flex-row mb-4 space-x-4 md:justify-between">
        <div class="my-4 space-y-4 relative w-full">
            <div>
                <label for="cif" class="block mb-2 text-xs font-medium text-gray-900">CIF Bank</label>
                <input value="{{ $nasabah->CIF }}" type="text" name="cif" id="cif" class=" max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500 dark:shadow-sm-light" placeholder="" required>
            </div>
            ...
            <div class="flex space-x-2">
                <div>
                    ...
                    <div class="relative max-w-[220px]" id="tglperm">
                        ...
                        <input value="{{ date('d-m-Y', strtotime($nasabah->TGL_PERMOHONAN)) }}" name="tgl_permohonan" datepicker datepicker-autohide type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full pl-10  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500" placeholder="Pilih Tanggal">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative max-w-[220px]" id="tglan">
                        ...
                        <input value={{ date('d-m-Y', strtotime($nasabah->TGL_ANALISA)) }} name="tgl_analisa" datepicker datepicker-autohide type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full pl-10  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500" placeholder="Pilih Tanggal">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="permohonan" class="my-4 space-y-4">
        ...
        <div class="md:flex md:flex-row space-y-4 space-x-4 md:space-y-0 mb-4 md:justify-between">
            <div class="space-y-4 w-full">
                <div>
                    <label for="limit" class="block mb-2 text-xs font-medium text-gray-900">Limit Kredit yang Dimohon</label>
                    <input value={{ $nasabah->LIMIT_KREDIT }} name="limit_kredit" type="text" id="limit" class=" max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 " required>
                </div>
                ...
                <div class="flex justify-between max-w-md">
                    <div class="">
                        <label for="jawaktu" class="block mb-2 text-xs font-medium text-gray-900">Jangka Waktu yang Dimohon</label>
                        <div class="flex flex-row">
                            <input value={{ $nasabah->JANGKA_WAKTU }} name="jangka_waktu"  type="text" id="jawaktu" class=" z-10 max-w-[80px] shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 " required>
                            <p class=" ml-3 my-auto place-item-center text-xs font-medium text-gray-500">
                                Bulan
                            </p>
                        </div>
    ...
    <section id="datadiri" class="my-4 space-y-4">
        ...
        <div class="md:flex md:flex-row space-x-4 mb-4 md:justify-between">
            <div class="my-4 space-y-4 w-full">
                <div>
                    <label for="jenisperm" class="block mb-2 text-xs font-medium text-gray-900">Nama Debitur</label>
                    <input value="{{ $nasabah->NAMA }}" name="nama_debitur" type="text" id="jenisperm" class=" max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 " required>
                </div>
                ...
                <div class="flex flex-row space-x-2 max-w-md">
                    <div>
                        <label for="tujuanpeng" class="block mb-2 text-xs font-medium text-gray-900">Tempat Lahir</label>
                        <input value="{{ $nasabah->TEMPAT_LAHIR }}" name="tempat_lahir" type="text" id="tujuanpeng" class=" max-w-sm shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 " required>
                    </div>
                    <div>
                        <label for="tglperm" class="block mb-2 text-xs font-medium text-gray-900">Tanggal Lahir</label>
                        <div class="relative max-w-[150px]" id="tglperm">
                ...
                <div class="flex space-x-2 max-w-md">
                    <div>
                        <label for="ktp" class="block mb-2 text-xs font-medium text-gray-900">Nomor KTP</label>
                        <input value="{{ $nasabah->NO_KTP }}"name="no_ktp" type="text" id="ktp" class=" max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 " required>
                    </div>
                    <div>
                        <label for="tglktp" class="block mb-2 text-xs font-medium text-gray-900">Masa Berlaku</label>
                        <div class="flex space-x-2">
                            ...
                            <div class="flex my-auto items-center">
                                <input name="tgl_berlaku_ktp" value="null" id="default-radio-2" type="radio" name="default-radio" class=" my-auto w-4 h-4 text-green-600 bg-gray-100 border-gray-300 focus:ring-green-500 dark:focus:ring-green-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for="default-radio-2" class="ml-2 text-xs font-medium text-gray-500 dark:text-gray-300">Seumur Hidup</label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="my-4 space-y-4 w-full">
                <div class="flex space-x-2 w-full justify-between max-w-md">
                    <div>
                        <label for="noprib" class="block mb-2 text-xs font-medium text-gray-900">Nomor Telepon Pribadi</label>
                        <input value="{{ $nasabah->NO_TELP }}" name="nomor_telepon" type="text" id="nokan" class=" max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 " required>
                    </div>
                ...
                <div class="flex space-x-2 justify-between max-w-md">
                    ...
                    <div class="">
                        <label for="margin" class="block mb-2 text-xs font-medium text-gray-900">Lama Tinggal</label>
                        <div class="flex flex-row">
                            <input value="{{ $nasabah->LAMA_TINGGAL }}" name="lama_tinggal" type="text" id="margin" class=" z-10 max-w-[80px] shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 " required>
                            <p class=" ml-3 my-auto place-item-center text-xs font-medium text-gray-500">
                                Tahun
                            </p>
                        </div>
                ...
                <div class="flex space-x-2 justify-between max-w-md">
                    ...
                    <div class="">
                        <label for="margin" class="block mb-2 text-xs font-medium text-gray-900">Jumlah Tanggungan</label>
                        <div class="flex flex-row">
                            <input value="{{ $nasabah->JUMLAH_TANGGUNGAN }}" name="jumlah_tanggungan" type="text" id="margin" class=" z-10 max-w-[80px] shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 " required>
                            <p class=" ml-3 my-auto place-item-center text-xs font-medium text-gray-500">
                                Orang
                            </p>
                        </div>
    ...
    <section id="3and4" class="md:flex md:flex-row mb-4 space-x-4 md:justify-between">
        <div class="space-y-4 space-x-4 w-full">
            <section id="suami_istri" class="my-4 space-y-4">
                ...
                <div>
                    <label for="noprib" class="block mb-2 text-xs font-medium text-gray-900">Nama Suami / Istri</label>
                    <input value="{{ $nasabah->NAMA_PASANGAN }}" name="nama_pasangan" type="text" id="nokan" class=" max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 " required>
                </div>
            
                <div class="flex justify-between max-w-md">
                    <div>
                        <label for="tujuanpeng" class="block mb-2 text-xs font-medium text-gray-900">Tempat Lahir</label>
                        <input value="{{ $nasabah->TEMPAT_LAHIR_PASANGAN }}" name="tempat_lahir_pasangan" type="text" id="tujuanpeng" class=" max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 " required>
                    </div>
                    <div>
                        <label for="tglperm" class="block mb-2 text-xs font-medium text-gray-900">Tanggal Lahir</label>
                        <div class="relative max-w-[220px]" id="tglperm">
                ...
                <div>
                    <label for="alamatktp" class="block mb-2 text-xs font-medium text-gray-900 dark:text-white">Alamat Sesuai KTP</label>
                    <textarea name="alamat_ktp_pasangan" id="alamatktp" rows="4" class=" max-w-md block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500" placeholder="Tulis Keterangan...">{{ $nasabah->ALAMAT_PASANGAN }} </textarea>        
                </div>
                ...
                <div class=" flex max-w-md justify-between">
                    ...
                    <div>
                        <label for="noprib" class="block mb-2 text-xs font-medium text-gray-900">Nomor Telepon / HP</label>
                        <input value="{{ $nasabah->NO_TELP_PASANGAN }}"name="nomor_telepon_pasangan" type="text" id="nokan" class=" max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 " required>
                    </div>
                </div>
            </section>
        </div>
        <div class="space-y-4 relative w-full">
            <section id="emergency" class="my-4 space-y-4 max-w-md">
                ...
                <div>
                    <label for="noprib" class="block mb-2 text-xs font-medium text-gray-900">Nama Lengkap</label>
                    <input value="{{ $nasabah->NAMA_EC }}" name="nama_kontak_darurat" type="text" id="nokan" class=" max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 " required>
                </div>
    ...
    <section id="bun" class="my-4 space-y-4">
        ...
        <div>
            <label for="noprib" class="block mb-2 text-xs font-medium text-gray-900">Nama Badan Usaha</label>
            <input value="{{ $nasabah->NAMA_BADAN_USAHA }}" name="nama_badan_usaha" type="text" id="nokan" class=" max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 " required>
        </div>
        ...
        <div class="flex max-w-md justify-between space-x-2">
            ...
            <div class="">
                <label for="jawaktu" class="block mb-2 text-xs font-medium text-gray-900">Jumlah Karyawan</label>
                <div class="flex flex-row">
                    <input value ="{{ $nasabah->JUMLAH_KARY }}" name="jumlah_karyawan" type="text" id="jawaktu" class=" z-10 max-w-[100px] shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 " required>
                    <p class=" ml-3 my-auto place-item-center text-xs font-medium text-gray-500">
                        Orang
                    </p>
                </div>
