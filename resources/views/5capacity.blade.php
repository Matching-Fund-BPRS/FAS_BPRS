...
<form method="post" action="{{ route('postCapacity') }}">
    ...
    <section id="capacity" class="my-4 max-w-xl space-y-4">
        ...
        <input name="id" value="{{ $nasabah->ID_NASABAH }}" type="hidden">
            <div class= "min-w-xl">
                <label for="cb_manajemen_sdm" class="block mb-2 text-xs font-medium text-black">Manajemen Keuangan</label>
                <select name="cb_manajemen_sdm" id="cb_manajemen_sdm" class=" bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5">
            ...
            <div class= "min-w-xl">
                <label for="cb_pengelolaan" class="block mb-2 text-xs font-medium text-black">Kemampuan Pengelolaan</label>
                <select name="cb_pengelolaan" id="cb_pengelolaan" class=" bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5">
            ...
            <div>
                <label for="cb_dscr" class="block mb-2 text-xs font-medium text-black">DSCR</label>
                <input name="cb_dscr" type="text" id="cb_dscr" class=" max-w-[200px] shadow-sm bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
            </div>

            <div class= "min-w-xl">
                <label for="teh_utilisasi" class="block mb-2 text-xs font-medium text-black">Utilisasi Kapasitas Usaha</label>
                <select name="teh_utilisasi" id="teh_utilisasi" class=" bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5">
            ...
            <div class= "min-w-xl">
                <label for="teh_lama_usaha" class="block mb-2 text-xs font-medium text-black">Lama Usaha</label>
                <select name="teh_lama_usaha" id="teh_lama_usaha" class=" bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5">
...
<form method="post" action="/dashboard/5capacity/{{ $nasabah->ID_NASABAH }}/edit">
    ...
    <section id="capacity" class="my-4 max-w-xl space-y-4">
        <p class="block py-4 text-base font-semibold text-black">
            ...
            <div>
                <label for="cb_dscr" class="block mb-2 text-xs font-medium text-black">DSCR</label>
                <input value="{{ $capacity_nasabah->CB_DSCR }}" name="cb_dscr" type="text" id="cb_dscr" class=" max-w-[200px] shadow-sm bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" readonly required>
            </div>
