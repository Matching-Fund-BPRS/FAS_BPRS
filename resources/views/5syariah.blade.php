    ...
    <section id="syariah" class="my-4 max-w-xl space-y-4">
        ...
        <input name="id" value="{{ $nasabah->ID_NASABAH }}" type="hidden">
            ...
            <div>
                ...
                <input value="{{ $syariah_nasabah->SY_JUMLAH_HUTANG ?? 0}}" name="jumlah_hutang" type="text" id="cb_dscr" class=" max-w-[200px] shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
            </div>
            ...
            <div class="flex justify-between items-center">
                ...
                <p class="text-base">
                    Hasil : <span class="text-blue-700 font-bold"> {{ $scoring_syariah }}</span>
                </p>
            </div>
    </section>
</form>
