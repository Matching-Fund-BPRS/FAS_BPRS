    ...
    <section id="permohonan" class="my-4">
        ...
        <div class="flex space-x-4 border-b p-3">
            <div>
                ...
                <input name="legalitas_pemohon" type="text" id="sifat_plafond" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
            </div> 
            <div>
        ...
        <div class="flex space-x-4 border-b p-3">
            ...
            <div>
                <label for="sifat_plafond" class="block mb-2 text-xs font-medium text-gray-900">Nomor</label>
                <input name="legalitas_pendirian_usaha_no" type="text" id="sifat_plafond" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
            </div>
            <div>
...
<form method="post" action="/dashboard/ankual/{{ $nasabah->ID_NASABAH }}/edit">
    ...
    <section id="permohonan" class="my-4">
        ...
        <div class="flex space-x-4 border-b p-3">
            <div>
                <label for="sifat_plafond" class="block mb-2 text-xs font-medium text-gray-900">Legalitas Pemohon</label>
                <input value="{{ $ankual_nasabah->LEG_PEMOHON }}" name="legalitas_pemohon" type="text" id="sifat_plafond" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
            </div> 
            <div>
                <label for="sifat_plafond" class="block mb-2 text-xs font-medium text-gray-900">Nomor</label>
                <input value="{{ $ankual_nasabah->LEG_PEMOHON_NO }}" name="legalitas_pemohon_no" type="text" id="sifat_plafond" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
            </div>
            <div>
                <label for="tglperm" class="block mb-2 text-xs font-medium text-gray-900">Masa Laku</label>
                <div class="relative max-w-[220px]" id="tglperm">
        ...
        <div class="flex space-x-4 border-b p-3">
            ...
            <div>
                <label for="sifat_plafond" class="block mb-2 text-xs font-medium text-gray-900">Nomor</label>
                <input value="{{ $ankual_nasabah->LEG_PENDIRIAN_NO }}" name="legalitas_pendirian_usaha_no" type="text" id="sifat_plafond" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
            </div>
            <div>
                <label for="tglperm" class="block mb-2 text-xs font-medium text-gray-900">Tanggal Terbit</label>
                <div class="relative max-w-[220px]" id="tglperm">
    ...
    <div class="md:flex md:flex-row mb-4 md:justify-between">
        <div class="w-full">
            <section id="pemasaran" class="my-4 space-y-4">
                ...
                <div>
                    <label for="sifat_plafond" class="block mb-2 text-xs font-medium text-gray-900">Jumlah Pesaing</label>
                    <input value="{{ $ankual_nasabah->PEM_PESAING }}" name="jumlah_pesaing" type="text" id="sifat_plafond" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                </div>
                <div>
                    <label for="sifat_plafond" class="block mb-2 text-xs font-medium text-gray-900">Reputasi dengan Pelanggan</label>
                    <input value="{{ $ankual_nasabah->PEM_REPUTASI }}" name="reputasi_pelanggan" type="text" id="sifat_plafond" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                </div>
                <div>
                    <label for="sifat_plafond" class="block mb-2 text-xs font-medium text-gray-900">Jumlah Pelanggan</label>
                    <input value="{{ $ankual_nasabah->PEM_PELANGGAN }}" name="jumlah_pelanggan" type="text" id="sifat_plafond" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                </div>
                <div>
                    <label for="sifat_plafond" class="block mb-2 text-xs font-medium text-gray-900">Prospek Usaha</label>
                    <input value="{{ $ankual_nasabah->PEM_KETERGANTUNGAN }}" name="prospek_usaha" type="text" id="sifat_plafond" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                </div>
                <div>
                    <label for="sifat_plafond" class="block mb-2 text-xs font-medium text-gray-900">Kebutuhan Masyarakat teerhadap Produk</label>
                    <input value="{{ $ankual_nasabah->PEM_KEBUTUHAN }}" name="kebutuhan_masyarakat" type="text" id="sifat_plafond" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                </div>       
            </section>
        </div>
        ...
        <div class="w-full">
            <section id="pemasaran" class="my-4 space-y-4">
                ...
                <div>
                    <label for="sifat_plafond" class="block mb-2 text-xs font-medium text-gray-900">Kejujuran</label>
                    <input value="{{ $ankual_nasabah->MAN_KEJUJURAN }}" name="kejujuran" type="text" id="sifat_plafond" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                </div>
                <div>
                    <label for="sifat_plafond" class="block mb-2 text-xs font-medium text-gray-900">Kemauan Bekerja Keras</label>
                    <input value="{{ $ankual_nasabah->MAN_KEMAUAN }}" name="kemauan_bekerja_keras" type="text" id="sifat_plafond" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                </div>
                <div>
                    <label for="sifat_plafond" class="block mb-2 text-xs font-medium text-gray-900">Reputasi dengan Rekan Bisnis</label>
                    <input value="{{ $ankual_nasabah->MAN_REPUTASI }}" name="reputasi_rekan_bisnis"type="text" id="sifat_plafond" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                </div>         
            </section>
        </div>
    </div>
    ...
    <section class="my-4">
        ...
        <div class="md:flex md:flex-row mb-4 md:justify-between">
            <div class="space-y-4 w-full">
                <div>
                    <label for="sifat_plafond" class="block mb-2 text-xs font-medium text-gray-900">Utilitas Kapasitas Usaha</label>
                    <input value="{{ $ankual_nasabah->TEH_UTILISASI }}" name="utilitas_kapasitas_usaha" type="text" id="sifat_plafond" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                </div>
                <div>
                    <label for="sifat_plafond" class="block mb-2 text-xs font-medium text-gray-900">Pengadaan Bahan Baku</label>
                    <input value="{{ $ankual_nasabah->TEH_PENGADAAN }}" name="pengadaan_bahan_baku" type="text" id="sifat_plafond" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                </div>
                <div>
                    <label for="sifat_plafond" class="block mb-2 text-xs font-medium text-gray-900">Reputasi dengan Supplier</label>
                    <input value="{{ $ankual_nasabah->TES_REPUTASI }}" name="reputasi_supplier" type="text" id="sifat_plafond" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                </div>
            </div>
            ...
            <div class="space-y-4 w-full">
                <div>
                    <label for="sifat_plafond" class="block mb-2 text-xs font-medium text-gray-900">Ketergantungan terhadap Supplier</label>
                    <input value="{{ $ankual_nasabah->TEH_KETERGANTUNGAN }}" name="ketergantungan_supplier" type="text" id="sifat_plafond" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                </div>
                <div>
                    <label for="sifat_plafond" class="block mb-2 text-xs font-medium text-gray-900">Spesifikasi Produk</label>
                    <input value="{{ $ankual_nasabah->TEH_SPESIFIKASI }}" name="spesifikasi_produk" type="text" id="sifat_plafond" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                </div>
                <div>
                    <label for="sifat_plafond" class="block mb-2 text-xs font-medium text-gray-900">Lama Usaha</label>
                    <input value="{{ $ankual_nasabah->TEH_LAMA_USAHA }}" name="lama_usaha" type="text" id="sifat_plafond" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                </div>
            </div>
        </div>
    </section>
