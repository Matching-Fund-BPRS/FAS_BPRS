        ...
        <div>
            <section id="permohonan_nasabah" class=" my-4 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="limit_kredit" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                </div>
            
                <div class="">
                    <label for="jawaktu" class="block mb-2 text-xs font-medium text-gray-900">Jangka Waktu</label>
                    <div class="flex flex-row">
                        <input name="jangka_waktu"  type="text" id="jangka_waktu" class=" z-10 max-w-[80px] shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 " required>
                ...
                <div class="my-4 space-y-4 md:grid md:grid-cols-2">
                    <div class="my-4 space-y-4">
                        ...
                        <div>
                            ...
                            <input name="hpp" type="text" id="hpp" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                        </div>
                    
                        <div>
                            <label for="laba_kotor" class="block mb-2 text-xs font-medium text-gray-900">Laba Kotor</label>
                            <input name="laba_kotor" type="text" id="laba_kotor" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                        </div>
                    
                        <div>
                            <label for="total_biaya" class="block mb-2 text-xs font-medium text-gray-900">Total Biaya Ops dan Non Ops</label>
                            <input name="total_biaya_ops_nonops" type="text" id="total_biaya" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input name="angsuran_bank_lain" type="text" id="angsuran_lain" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                        </div>
                    ...
                    <div class=" my-4 space-y-4">
                        ...
                        <div>
                            ...
                            <input name="biaya_lain" type="text" id="biaya_lain" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input name="biaya_pajak" type="text" id="biaya_pajak" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                        </div>
