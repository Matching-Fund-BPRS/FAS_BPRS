            ...
            <section id="permohonan_nasabah" class=" my-4 space-y-4 grid grid-cols-2">
                <div class="space-y-4 my-auto justify-center">
                    ...
                    <div>
                        ...
                        <input readonly type="text" name="limit_kredit" id="limit_kredit" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" 
                    ...
                    <div class="">
                        ...
                        <div class="flex flex-row">
                            <input readonly name="jangka_waktu"  type="text" id="jangka_waktu" class=" z-10 max-w-[80px] shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 " 
                    ...
                    <div class= "min-w-xl">
                        ...
                        <select disabled id="countries" class=" max-w-md bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5">
                ...
                <div class=" space-y-4 my-auto justify-center">
                    ...
                    <div class="">
                        ...
                        <div class="flex flex-row">
                            <input readonly  name="margin"  type="text" id="margin" class=" z-10 max-w-[80px] shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 " 
                    ...
                    <div>
                        ...
                        <input readonly name="angsuran" type="text" id="angsuran" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                    </div>
                ...
                <div class="my-4 space-y-4">
                    <div class="my-4 space-y-4">
                        <div>
                            ...
                            <input readonly  name="omset" type="text" id="omset" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" 
                        ...
                        <div>
                            ...
                            <input readonly name="hpp" type="text" id="hpp" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" 
                        ...
                        <div>
                            ...
                            <input readonly name="laba_kotor" type="text" id="laba_kotor" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" 
                             required>
                        </div>
                    
                        <div>
                            <label for="total_biaya" class="block mb-2 text-xs font-medium text-gray-900">Total Biaya Ops dan Non Ops</label>
                            <input readonly name="total_biaya_ops_nonops" type="text" id="total_biaya" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" 
                        ...
                        <div>
                            ...
                            <input readonly name="laba_kotor_operasional" type="text" id="laba_kotor_ops" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                        </div>
                    
                        <div>
                            <label for="angsuran_lain" class="block mb-2 text-xs font-medium text-gray-900">Angsuran Bank Lain</label>
                            <input readonly name="angsuran_bank_lain" type="text" id="angsuran_lain" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" 
                        ...
                        <div>
                            ...
                            <input readonly name="laba_bersih_operasional" type="text" id="laba_bersih_ops" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                        </div>
                    </div>
                    ...
                    <div class=" my-4 space-y-4">
                        <div>
                            ...
                            <input readonly name="pendapatan_lain" type="text" id="pendapatan_lain" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" 
                        ...
                        <div>
                            ...
                            <input readonly name="biaya_lain" type="text" id="biaya_lain" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" 
                        ...
                        <div>
                            ...
                            <input readonly name="ebit" type="text" id="ebit" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                        </div>
                    
                        <div>
                            <label for="biaya_margin" class="block mb-2 text-xs font-medium text-gray-900">Biaya Margin</label>
                            <input readonly name="biaya_margin" type="text" id="biaya_margin" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input readonly name="laba_bersih"type="text" id="eait" class="max-w-md shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                        </div>
                    </div>   
                </div>
