...
<nav class="bg-white border-gray-200 dark:bg-gray-900 fixed w-full z-50 border-b-2">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <button data-collapse-toggle="navbar-defaultnota" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-black rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 " aria-controls="navbar-default" aria-expanded="false">
        ...
        <div class="mt-3">
            <nav class="-mx-3 space-y-3 relative">
                ...
                <div class="space-y-1">
                    ...
                    <a class="flex items-center py-1 px-1 text-black transition-colors duration-300 transform rounded-lg hover:bg-green-800 hover:text-white" href="#" onClick="alert('Silakan masukkan ID Nasabah terlebih dahulu!')">
                    ...
                    <a  type="button" class="flex items-center py-1 px-1 text-black transition-colors duration-300 transform rounded-lg hover:bg-green-800 hover:text-white" href="#">
                    ...
                    <a class="flex items-center py-1 px-1 text-black transition-colors duration-300 transform rounded-lg hover:bg-green-800 hover:text-white" href="/dashboard/infokeuangan">
                        <span class="mx-2 text-sm font-normal">Info Keuangan</span>
                    </a>
    
                    <a class="flex items-center py-1 px-1 text-black transition-colors duration-300 transform rounded-lg hover:bg-green-800 hover:text-white" href="/dashboard/limitkredit">
                        <span class="mx-2 text-sm font-normal">Perhitungan Limit Kredit</span>
                    </a>
    
                    <a class="flex items-center py-1 px-1 text-black transition-colors duration-300 transform rounded-lg hover:bg-green-800 hover:text-white" href="#">
                ...
                @else
                <a class="flex items-center py-1 px-1 text-black transition-colors duration-300 transform rounded-lg hover:bg-green-800 hover:text-white" href="/dashboard/danolisa/{{ $nasabah->ID_NASABAH }}">
                    <span class="mx-2 text-sm font-normal">Detail Data Entry</span>
                </a>
