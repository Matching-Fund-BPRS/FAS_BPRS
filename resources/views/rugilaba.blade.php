...
<div class="flex flex-col mt-6">
    <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="inline-block min-w-full max-w-screen-xl py-2 align-middle md:px-6 lg:px-8 ">
            <form method="post" action="" id="laba_rugi_form" class="flex flex-col">
                    ...
                    <tbody class="bg-white divide-y divide-gray-20">
                        <tr>
                            ...
                            <td class="px-4 py-1 whitespace-nowrap flex">
                                    <input type="date" name="periode" class="text-sm font-normal text-center text-gray-600 border-none p-0 mx-auto">
                            </td>
